...
//| [[slots_table.market_role]]<<market_role,`market_role`>>
| 1..* +
...
| xref::class/ForecastDataSet.adoc[`ForecastDataSet`] | xref::class/ForecastDataSet.adoc#market_participants[`market_participants`]



| xref::class/RegisteredResource.adoc[`RegisteredResource`] | xref::class/RegisteredResource.adoc#market_participant[`market_participant`]
