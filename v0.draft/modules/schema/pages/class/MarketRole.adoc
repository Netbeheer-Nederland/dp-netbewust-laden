...
| +++The kind of market roles that can be played by parties for given domains within the electricity market. Types are flexible...+++
| _n/a_
...
| xref::class/ForecastDataSet.adoc[`ForecastDataSet`] | xref::class/ForecastDataSet.adoc#market_roles[`market_roles`]



| xref::class/MarketParticipant.adoc[`MarketParticipant`] | xref::class/MarketParticipant.adoc#market_role[`market_role`]
