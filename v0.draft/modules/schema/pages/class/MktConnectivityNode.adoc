...
//| [[slots_table.registered_resource]]<<registered_resource,`registered_resource`>>
| 1..* +
...
[.text-left]
--
<<slots_table.registered_resource,&#10548;>>
--
////
...
| xref::class/ForecastDataSet.adoc[`ForecastDataSet`] | xref::class/ForecastDataSet.adoc#mkt_connectivity_nodes[`mkt_connectivity_nodes`]
