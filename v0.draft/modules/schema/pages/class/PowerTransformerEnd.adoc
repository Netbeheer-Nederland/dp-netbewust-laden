...
//| [[slots_table.base_voltage]]<<base_voltage,`base_voltage`>>
| 1 +
...
| xref::class/PowerTransformer.adoc[`PowerTransformer`] | xref::class/PowerTransformer.adoc#power_transformer_end[`power_transformer_end`]
